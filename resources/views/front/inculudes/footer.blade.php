                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                    <div class="footer-item fi-2 clearfix">
                        <div class="footer-gallery clearfix">
                            ...
                            <ul>
                                <li>
                                    <img src="assets/front/img/sub-property/sub-property.jpg" alt="small-img">
                                </li>
                                <li>
                                    <img src="assets/front/img/sub-property/sub-property-2.jpg" alt="small-img">
                                </li>
                                <li>
                                    <img src="assets/front/img/sub-property/sub-property-3.jpg" alt="small-img">
                                </li>
                                <li>
                                    <img src="assets/front/img/sub-property/sub-property-4.jpg" alt="small-img">
                                </li>
                                <li>
                                    <img src="assets/front/img/sub-property/sub-property-5.jpg" alt="small-img">
                                </li>
                                <li>
                                    <img src="assets/front/img/sub-property/sub-property-6.jpg" alt="small-img">
                                </li>
                            </ul>
                        </div>
                    </div>
